...
urlpatterns = [
    ...
    path("SIGNAL_BLOCK/3/eventAction", signal_blocks.views.get_event_actions),
    path("SIGNAL_BLOCK/3/crossoverType", signal_blocks.views.get_crossover_types),
    path("SIGNAL_BLOCK/3/run", signal_blocks.views.PostCrossoverRun.as_view()),
