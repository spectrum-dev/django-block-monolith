...
class BacktestBlock(TestCase):
    ...
    def test_backtest_zero_start_value_error(self):
        payload = {
            "input": {
                "start_value": 0.00,
                "commission": 4.95,
    ...
    def test_backtest_empty_outputs_in_payload(self):
        payload = {
            "input": {
                "start_value": 1000.00,
                "commission": 4.95,
    ...
    def test_backtest_missing_data_block_in_outputs(self):
        payload = {
            "input": {
                "start_value": 1000.00,
                "commission": 4.95,
    ...
    def test_backtest_missing_signal_block_in_outputs(self):
        payload = {
            "input": {
                "start_value": 1000.00,
                "commission": 4.95,
